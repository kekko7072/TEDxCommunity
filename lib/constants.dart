...
const String kGitHubSourceCodeLink =
    'https://github.com/kekko7072/tedxcommunity';
const String kGitHubReadmeLink =
    'https://github.com/kekko7072/tedxcommunity#readme';
const String kGitHubCreditsLink =
    'https://github.com/kekko7072/tedxcommunity#credits';

const int kDurationToast = 500;

const int kConstantsResizeWidthValue = 600;
